...
const pool = new Pool({
  host: "dpg-ctr40n1opnds73foeir0-a.singapore-postgres.render.com",
  user: "dashboard_guvv_user",
  port: 5432,
  password: "KjclQKIY0wSgOPHBDz1GyJULyJDXOgYX", // Set your actual DB password
  database: "dashboard_guvv",
  ssl: {
