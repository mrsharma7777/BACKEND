...
const pool = new Pool({
  host: "dpg-d1t072mr433s73eqsnt0-a.singapore-postgres.render.com",
  user: "database_e8zo_user",
  port: 5432,
  password: "KtdeYLVbaLxQIeJ24KKcqqlIJffrd8P0",// Set your actual DB password
  database: "database_e8zo",
  ssl: {
