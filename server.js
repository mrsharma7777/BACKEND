...
const pool = new Pool({
 host: "dpg-cvl58sidbo4c73d7hoo0-a.singapore-postgres.render.com",
  user: "database_mcmw_user",
  port: 5432,
  password: "yPlmWDUMpIXP13rEh2qa2lBPMvdZVszi", // Set your actual DB password
  database: "database_mcmw",
  ssl: {
