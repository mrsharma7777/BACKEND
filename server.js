...
const pool = new Pool({
  host: "dpg-d5tjfsfgi27c73f93u3g-a.singapore-postgres.render.com",
  user: "database_xci9_user",
  port: 5432,
  password: "3W7uQB8Y4MlcFOsOs2LgoCFVAPpVAehN",// Set your actual DB password
  database: "database_xci9",
  ssl: {
