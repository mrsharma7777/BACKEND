...
const pool = new Pool({
  host: "dpg-d2rcmnfdiees73e6t780-a.singapore-postgres.render.com",
  user: "database_62jl_user",
  port: 5432,
  password: "SxeOpFgzpnK5bOMWqWlSnc5flE6jWVz1",// Set your actual DB password
  database: "database_62jl",
   ssl: {
