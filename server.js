...
const pool = new Pool({
  host: "dpg-d35rhvqli9vc738lpjc0-a.singapore-postgres.render.com",
  user: "database_dew4_user",
  port: 5432,
  password: "PW2e4j4zIpaJKWwRh7VILobVEDW0pLkw",// Set your actual DB password
  database: "database_dew4",
   ssl: {
