...
const pool = new Pool({
  host: "dpg-d98k50l8nd3s73cgh010-a.singapore-postgres.render.com",
  user: "transactions_2tmj_user",
  port: 5432,
  password: "A8fKP6dpS7k3w1azf40BX7AEuXJqMX29",// Set your actual DB password
  database: "transactions_2tmj",
  ssl: {
